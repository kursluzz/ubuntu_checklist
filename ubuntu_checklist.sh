...
if [[ "$INSTALL_PYCHARM_PRO" -eq 1 ]]; then
  ...
  wget https://download-cdn.jetbrains.com/python/pycharm-professional-2023.1.1.tar.gz
  tar -xzf pycharm-professional-2023.1.1.tar.gz 
  sudo mv pycharm-2023.1.1 /opt/pycharm-pro
  sudo chown -R ${USER}:${USER} /opt/pycharm-pro
  rm pycharm-professional-2023.1.1.tar.gz
fi
